...
Step 1: The Database
Duplicate the ZenSpend Google Sheet Template to your own Google Drive.

Go to File > Share > Publish to Web and publish the "Current" tab as a CSV. Copy this link.

Link a Google Form to the sheet to act as your POST webhook.

Step 2: The App
Go to the hosted Vercel link: [Your-Vercel-URL-Here]

Add the site to your iOS Home Screen.

Open the app, click the Gear icon, and paste your CSV Link, Budget, and Currency.

Step 3: The Pipeline
Install the ZenSpend Core Shortcut to your iPhone.

Edit the Shortcut once to paste your specific Google Form POST URL.
